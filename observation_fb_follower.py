...
graph=Graph()
rootPath = "/home/ytwen/observationData_follower_one/fb"
counter=0
timeIntervalAll=[]
rawIntervalAll=[]
distanceAll=[]
            ...
            for userVisitRecord in userVisitRecords:
                ...
                for totalR in totalRecords:
                    if(userVisitTime > float(totalR['r.atTime'].encode())):
                        ...
                        if(locData[0]['p.latitude'] != "NONE" and locData[0]['p.longitude'] != "NONE"):
...
#                        timeIntervalAll[366] = timeIntervalAll[366] + 1
    ...
    f = open('/home/ytwen/observationData_follower_one/fb/'+userID+'.csv','wb')
    ...
    w = open('/home/ytwen/rawobservationData_follower_one/fb/'+userID,'wb')
    w.write(json.dumps(rawInterval))
    w.close()
    
    d = open('/home/ytwen/observationData_follower_one/fb/'+userID+'_distance','wb')
...
z = open('/home/ytwen/observationData_follower_one/fb/sumData.csv','wb')
...
y = open('/home/ytwen/observationData_follower_one/fb/sumData_distance','wb')
