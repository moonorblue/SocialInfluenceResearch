...
def drawTimeSum(timelist):
    ...
    plt.xlabel('days')
    plt.savefig('/home/ytwen/chart/timefactor/gwl/Top10%-sum.png')
    plt.close()
...
def drawDisSum(data):
    ...
    plt.savefig('/home/ytwen/chart/distancefactor/gwl/Top10%-sum.png')
...
def drawTD(timelist,dislist):
    ...
    plt.ylabel('days')
    plt.xlabel('distance')
    plt.savefig('/home/ytwen/chart/timedistance/gwl/Top10%-sum.png')
    plt.close()
...
def drawTimeTopK(timelist,k):
    ...
    plt.ylabel('follow counts')
    plt.xlabel('days')
    plt.savefig('/home/ytwen/chart/timefactor/gwl/Top10%-NUM-'+str(k)+'.png')
    plt.close()
...
def drawDisTopK(disDic,k):
    ...
    plt.plot(dataL)
    plt.xticks(range(len(dataL)), interval, size='small')
    plt.savefig('/home/ytwen/chart/distancefactor/gwl/Top10%-NUM-'+str(k)+'.png')
    plt.close() 
...
def drawTDTopK(timelist,dislist,k):
    ...
    plt.ylabel('days')
    plt.xlabel('distance')
    plt.savefig('/home/ytwen/chart/timedistance/gwl/Top10%-NUM-'+str(k)+'.png')
    plt.close()
...
def drawTDWithC(timelist,dislist,c):
    ...
    plt.ylabel('days')
    plt.xlabel('distance')
    plt.savefig('/home/ytwen/chart/timedistance/gwl/Top10%-sumC.png')
    plt.close()
