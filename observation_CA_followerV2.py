...
graph=Graph()
rootPath = "/home/ytwen/observationData_follower_one/v2/CA"
counter=0
timeIntervalAll=[]
rawIntervalAll=[]
distanceAll=[]
...
for user in users:
    ...
    for friend in friends:
        visitRecords = graph.cypher.execute("MATCH (n:CAUser {id:{friendid}})-[r:VISITED]->(p:CAPlace) RETURN DISTINCT p.id;",{"friendid":friend['friend.id']})
        isVisit=[]
    ...
    f = open('/home/ytwen/observationData_follower_one/v2/CA/'+userID+'.csv','wb')
    ...
    w = open('/home/ytwen/rawobservationData_follower_one/v2/CA/'+userID,'wb')
    w.write(json.dumps(rawInterval))
    w.close()
    
    d = open('/home/ytwen/observationData_follower_one/v2/CA/'+userID+'_distance','wb')
    d.write(json.dumps(distance))
    d.close()

    
z = open('/home/ytwen/observationData_follower_one/v2/CA/sumData.csv','wb')
...
y = open('/home/ytwen/observationData_follower_one/v2/CA/sumData_distance','wb')
